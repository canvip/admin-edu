...
module.exports = {
  db: {
    uri: process.env.MONGOHQ_URL || process.env.MONGODB_URI || 'mongodb://' + (process.env.DB_1_PORT_43200_TCP_ADDR || 'canvip:canvip@ds043200.mlab.com:43200') + '/canvip',
    options: {},
  ...
  facebook: {
    clientID: process.env.FACEBOOK_ID || '165566907331560',
    clientSecret: process.env.FACEBOOK_SECRET || '8536b451e5ab2892e158410ef69ea136',
